					...
					<div class="bg-gray-800 rounded-lg p-6 border border-gray-700 hover:border-purple-600 transition-colors cursor-pointer">
						<div class="flex items-center justify-between">
							<div class="flex items-center">
								...
								<div class="ml-4">
									<p class="text-2xl font-semibold text-white">{dashboardStats.totalWebhooks}</p>
									<p class="text-sm text-gray-400">Webhooks</p>
								</div>
							</div>
							<div class="text-xs text-purple-400">{dashboardStats.webhookRequests} requests</div>
						</div>
					</div>
					
					<div class="bg-gray-800 rounded-lg p-6 border border-gray-700 hover:border-indigo-600 transition-colors cursor-pointer">
						<div class="flex items-center justify-between">
							<div class="flex items-center">
					...
					<div class="bg-gray-800 rounded-lg border border-gray-700 p-6">
						...
						<div class="space-y-3">
							...
							<button class="w-full flex items-center p-3 text-left bg-gray-700 hover:bg-gray-600 rounded-lg transition-colors group">
								...
								<div class="flex-1">
									<p class="text-sm font-medium text-white">Webhook Testing</p>
									<p class="text-xs text-gray-400">Create webhook endpoints</p>
								</div>
								<span class="text-xs text-gray-500 group-hover:text-gray-400">⌘W</span>
							</button>
							
							<button class="w-full flex items-center p-3 text-left bg-gray-700 hover:bg-gray-600 rounded-lg transition-colors group">
								<div class="p-2 bg-indigo-600 rounded mr-3">
									<svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
